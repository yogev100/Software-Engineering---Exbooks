...
import com.example.exbooks.Objects.EventDialog;
 ...
 */
public class BookEventAdapter extends  ArrayAdapter<Book> implements View.OnClickListener{
    ...
    public BookEventAdapter(ArrayList<Book> data, Context context, String screen, FragmentManager supportFragmentManager) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.choose_this_book_Button:
                openPhoneDialog(book.getUid());// open the event dialog
        }
    }
    ...
    private void openPhoneDialog(String otherUserId) {
        ...
        mRef.child(otherUserId).addListenerForSingleValueEvent(new ValueEventListener() {//if manager
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(m!=null){
                    EventDialog ed = new EventDialog(m);
                    ed.show(supportFragmentManager,"Event dialog");
                }
            }
        ...
        cRef.child(otherUserId).addListenerForSingleValueEvent(new ValueEventListener() {//if client
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(c!=null){
                    EventDialog ed = new EventDialog(c);
                    ed.show(supportFragmentManager,"Event dialog");
                }
            }
